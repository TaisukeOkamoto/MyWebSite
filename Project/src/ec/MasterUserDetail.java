 ...
 */
@WebServlet("/MasterUserDetail")
public class MasterUserDetail extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/master_user_detail.jsp");
