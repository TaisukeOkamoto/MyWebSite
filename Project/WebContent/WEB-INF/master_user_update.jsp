...
<%@ include file="include/master_header.jsp"%>
          ...
          <p class="text-center"><%--エラーチェック用 --%>
          <span class="alert-danger <c:if test="${memberCheckErr != null || memberCheckErr != null || emptyInputErr != null || emptyBitrhDayErr != null || differentPasswordErr != null || differentMailErr != null || StringPhoneNumberErr != null || StringAddressNumberErr != null || OverlapMailErr != null}">p-2</c:if>">
          ${memberCheckErr}${memberCheckErr}${emptyInputErr}${emptyBitrhDayErr}${differentPasswordErr}${differentMailErr}${StringPhoneNumberErr}${StringAddressNumberErr}${OverlapMailErr}
          </span>
          </p>
            <div class="sub_ttl">
              <h3>会員情報更新</h3></div>
